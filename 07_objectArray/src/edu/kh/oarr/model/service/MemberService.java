...
public class MemberService {
	...
	public MemberService() { // 기본 생성자
		...
		memberArr[2] = new Member("user03", "pass03", "이영희", 45, "강원");
		...
		do {
			...
			case 4 : 		
				...
				if(result == 0) {
					...
					System.out.println("로그인부터 먼저 진행하세요");
				}
				break;
	...
	public int emptyIndex() {
		...
		// for문을 수행했지만 return이 되지 않은 경우, 코드 수행
	...
	public String signUp() {
		...
		int index = emptyIndex(); // memberArr 배열에서 비어있는 인덱스를 반환받음.(없다면 -1 반환)
