...
public class User {
	...
	/*
	   [오버로딩 조건]
	   1) 메서드의 이름이 동일
	   2) 매개변수 개수, 타입, 순서 중 1개라도 달라야 함.
	 */  
	// public User () {} // 기본 생성자가 이미 작성되어 있어 중복
   
	public User(String userId) {} // 오버로딩 성립
	// --> 매개변수의 개수가 같은 생성자가 없음 
	
	public User(int userAge) {} // 오버로딩 성립
	// --> 매개변수의 개수는 같지만 타입이 다름
	
	public User(String userId, int UserAge) {} // 오버로딩 성립
	// --> 매개변수의 개수와 동일한 것이 있으나, 하나의 타입이 다름
	
	public User(int userAge, String userId) {} // 오버로딩 성립
