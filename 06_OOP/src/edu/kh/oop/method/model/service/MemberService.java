...
public class MemberService {
	...
	public String signUp() {
		...
		System.out.println("\n*******회원 가입*******"); // 상단에 System.out.print("메뉴 입력 : ");
	...
	public String login() {
		...
		// 회원가입을 했는지부터 확인
		// == memberInfo가 객체를 참조하고 있는지 확인(null 여부 확인)
		...
		if(memberId.equals(memberInfo.getMemberId()) &&
			...
			// 참조형 = Member객체 주소(얕은 복사) == 같은 주소 참조
