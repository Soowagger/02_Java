...
public class JavaAPIService {
	 ...
	 * char     <--> Character
	 * 
	 * * Boxing, Unboxing이 자동으로 수행되도록 구현되어 있음
	...
	public void method1() {
		...
		// print 구문 내 Wrapper 클래스로 만든 객체를 참조할 때
		// .toString() 호출하는 것이 아닌
	...
	public void method2() {
		...
		// 정수형, 실수형 공통
		System.out.println("byte의 용량 : " + Byte.BYTES + "byte");
		System.out.println("byte의 용량 : " + Byte.SIZE + "bit");
		...
		// String 이어쓰기를 이용한 방법
		// -> 코드는 짧지만 효율이 좋지 않음(속도 DOWN, 메모리 소모 UP)
	...
	public void method5() {
		...
		temp2 += "efg";
		System.out.println("temp2 + efg : " + System.identityHashCode(temp2));
		// 1744347043 -> 1618212626 해시코드 변경
	...
	public void method6() {
		...
		System.out.println(sb); // 2월 21일 오늘 점심은 무엇을 먹을까요?
		...
		String[] arr = temp.split(" "); // // "2월^21일^오늘^점심은^무엇을^먹을까요?"
