...
public class VariableExample2 {
	public static void main(String[] args) {
		...
		booleanData = true; // booleanData 변수에 true 값을 대입
		
		System.out.println("booleanData : " + booleanData);
		
		
		byte byteNumber = 127; // byte 범위 : -128 ~ 127 
		...
		short shortNumber = 32767; // 32768부터 에러
		
		// 정수 자료형 기본형! (short, byte는 옛날 코드 잔재, 잘 안씀!)
		int intNumber = 2147483647;
	// 자료형 변수명  =  리터럴;
		
		// 프로그래밍에서는 대입되는 데이터(값자체)를 '리터럴'이라는 단어로도 표현
		
		// * 리터럴 : 변수에 대입되거나 작성되어지는 '값 자체'
		// - 자료형에 따라 리터럴 표기법이 다름.
		
		long longNumber = 1000000000000L; // L 또는 l
		// error : The literal 1000000000000 of type int is out of range
		// -> 100억이라는 값은 int의 범위를 벗어났다. int는 21억 몇까지만 가능
		// 뒤에 L을 붙여줌으로써 long 자료형인 것을 나타냄
		
		float floatNumber = 1.2345f; // F 또는 f
		// error : Type mismatch: cannot convert from double to float
		// 1.2345만 쓰면 double 자료형이기 때문에 에러 발생
		...
		System.out.println("ch2 : " + ch2); // ch : B
		 ...
		 * 
		 * - 상수 명명 규칙 : 모두 대문자, 여러 단어 작성 시 _사용
		 * 
		 * - 상수를 사용하는 경우
