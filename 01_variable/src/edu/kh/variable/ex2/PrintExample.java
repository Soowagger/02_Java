...
public class PrintExample {
	...
	public static void main(String[] args) {
		...
		// 1. System.out.print() : 단순 출력(출력 후 줄바꿈 X)
		// 2. System.out.println() : 한 줄 출력(출력 후 줄바꿈 수행)
		...
		// 3. System.out.printf() : 출력될 문자열 형식을 패턴으로 지정하는 출력 구문
		
		System.out.println(); // 위에 print 구문 때문에 줄바꿈
		...
		// 소수점 자리 제어(반올림 처리)
		System.out.printf("%f\n", 10/4.0); // 2.500000
		System.out.printf("%.2f\n", 10/4.0); // 2.50 - 소수점 둘째 자리까지만 나타내고 싶다.
