...
import edu.kh.poly.ex2.model.service.SSMCalculator;
...
public class AbstractRun {
	public static void main(String[] args) {
		...
		// Calculator calc = new SSMCalculator();
		Calculator calc = new HGDCalculator();
		
		System.out.println("합 : " + calc.plus(20, 30));
		System.out.println("차 : " + calc.minus(20, 30));
		System.out.println("곱 : " + calc.multiple(20, 30));
		System.out.println("몫 : " + calc.divide(20, 30));
		
		// 인터페이스 == 미완성 설계도 == 객체 생성 불가
		// 추상 클래스처럼 참조변수로는 사용 가능
		
		// 코드의 큰 수정 없이 객체 생성 코드만 바뀌면,
		...
		/* 인터페이스 특징
		   ...
		   -> 이를 이용하여 공동 작업(팀 프로젝트)에 필요한 개발 환경 조성
		*/ 
